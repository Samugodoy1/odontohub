...
export const TermsPage = () => {
  return (
    <div className="min-h-screen bg-slate-50 py-12 px-4 sm:px-6 lg:px-8 font-['Montserrat']">
      <div className="max-w-3xl mx-auto bg-white p-8 sm:p-12 rounded-3xl shadow-sm border border-slate-100">
        <Link to="/" className="inline-flex items-center text-emerald-600 font-bold mb-8 hover:gap-2 transition-all">
          <ChevronRight className="rotate-180" size={20} />
          Voltar para o Início
        </Link>
        
        <h1 className="text-3xl font-bold text-slate-900 mb-8">Termos de Uso — OdontoHub</h1>
        ...
        <div className="prose prose-slate max-w-none space-y-6 text-slate-600 leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-slate-800">2. Uso da Plataforma</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-slate-800">3. Responsabilidade Profissional</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-slate-800">4. Propriedade Intelectual</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-slate-800">5. Limitação de Responsabilidade</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-slate-800">6. Alterações nos Termos</h2>
          ...
          <p className="pt-8 text-sm text-slate-400 italic">Última atualização: 14 de Março de 2026</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="min-h-screen bg-slate-50 py-12 px-4 sm:px-6 lg:px-8 font-['Montserrat']">
      <div className="max-w-3xl mx-auto bg-white p-8 sm:p-12 rounded-3xl shadow-sm border border-slate-100">
        ...
        <h1 className="text-3xl font-bold text-slate-900 mb-8">Política de Privacidade — OdontoHub</h1>
        ...
        <div className="prose prose-slate max-w-none space-y-6 text-slate-600 leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-slate-800">3. Segurança dos Dados</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-bold text-slate-800">4. Compartilhamento de Dados</h2>
